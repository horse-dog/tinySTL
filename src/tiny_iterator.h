...
class __const_iterator<_Iterator, forward_iterator_tag>
{
protected:
  _Iterator current;
public:
  ...
  typedef _Iterator iterator_type;
  typedef __const_iterator<_Iterator, forward_iterator_tag> _Self;
...
// forward version.
template <class _Iterator>
class __reverse_iterator<_Iterator, forward_iterator_tag>
{
protected:
  _Iterator current;
public:
  ...
  typedef _Iterator iterator_type;
  typedef __reverse_iterator<_Iterator, forward_iterator_tag> _Self;
